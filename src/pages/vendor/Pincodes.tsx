...
const Pincodes: React.FC<{
  ...
  supported_pincodes,
  setFieldValue,
  editSupportedPincode,
  editSupportedPincodeIndex,
  setEditSupportedPincodeIndex
}) => {
          ...
          {({ errors, touched, handleChange, values }) => (
            <Form>
              ...
              <DialogActions>
                ...
                <Button type='submit'>{editSupportedPincode ? 'Edit' : 'Add'}</Button>
              </DialogActions>
            </Form>
          )}
        </Formik>
